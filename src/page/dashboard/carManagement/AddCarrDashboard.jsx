...
const AddCarrDashboard = () => {
   const {user} = useAuth();
   const [addCar, {isLoading}] = useAddCarMutation(undefined);
...
return (
    <div className="flex items-center justify-center min-h-screen p-4">
        <Card className="w-full max-w-2xl text-black shadow-xl">
            <CardHeader>
                <CardTitle className="text-center text-xl">Add New Car</CardTitle>
            </CardHeader>
            <CardContent>
                <Form {...form}>
...
export default AddCarrDashboard;